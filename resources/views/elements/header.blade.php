<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
    ...
    <div style="padding: 15px 50px 5px 50px;
         ...
         font-size: 16px;">
        @if(auth()->check())
        <span style="color: white;">Logged in as :</span> <a href="javascript:void(0);" title="View Profile" class="btn btn alert-info disp" data-toggle="modal" data-target="#myModal">{{ auth()->user()->name  }}</a> &nbsp;<a href="{{url('/logout')}}" class="btn btn-danger square-btn-adjust"><i class="fa fa-btn fa-sign-out"></i>Logout</a>
