    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            <li class="text-center">                
                @php $file = realpath(public_path("/image/user/".auth()->user()->id."/profile_image.jpg"));@endphp             
                @if(auth()->user()->user_type_id !== 0 && file_exists($file) === true)
                <img src="{{URL::asset("image/user/".auth()->user()->id."/profile_image.jpg")}}" class="user-image img-responsive"/>
                @else
