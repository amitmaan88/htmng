                                ...
                                <tbody>
                                    ...
                                    <tr class="gradeA {{($k%2==0?'even':'odd')}}">                                        
                                        ...
                                        <td class="col-xs-5">
                                            ...
                                            <button data-url="{{'/food'}}" type="button" class="btn {{($val->status == 1)?'btn-success':'btn-default'}} actinc" data-var="{{($val->status == 1)?0:1}}" data-id="{{$val->id}}">{{$Status[$val->status]}}</button>                                            
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
