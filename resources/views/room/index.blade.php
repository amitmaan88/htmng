                                ...
                                <table id="room_list" class="table table-striped table-bordered table-hover dataTable no-footer" aria-describedby="dataTables-example_info">
                                    <thead>
                                        <tr>                                        
                                            ...
                                            <th class="col-xs-4">Room Description</th>                                        
                                            <th class="col-xs-2">Assign Tenant</th>                                        
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeA {{($k%2==0?'even':'odd')}}">                                      
                                            ...
                                            <td class="col-xs-2">{{$val->room_name}}</td>                                                                                                             <td class="col-xs-4">
                                                <div class="col-xs-8"><label>Type:</label> {{$roomTypeList[$val->room_type]}}</div><div class="col-xs-4"><label>Chairs:</label> {{$val->chair_no}}</div>                                            
                                            ...
                                            <td class="col-xs-3">
                                                ...
                                                <button  tab_stat="1" data-url="{{'/room'}}" type="button" class="btn {{($val->status == 1)?'btn-default':'btn-success'}} actinc" data-var="{{($val->status == 1)?0:1}}" data-id="{{$val->id}}">{{$Status[$val->status]}}</button>
